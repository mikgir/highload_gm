...
class Crawler implements \Countable, \IteratorAggregate
{
    ...
    public function __construct(\DOMNodeList|\DOMNode|array|string $node = null, string $uri = null, string $baseHref = null)
    {
        ...
        $this->html5highload = new HTML5(['disable_html_ns' => true]);
    ...
    {
        return $this->html5highload->parse($this->convertToHtmlEntities($htmlContent, $charset));
    }
    ...
    private function createSubCrawler(\DOMNodeList|\DOMNode|array|string|null $nodes): static
    {
        ...
        $crawler->html5highload = $this->html5highload;
    ...
    /**
     * Parse string into DOMDocument object using HTML5 highload if the content is HTML5 and the library is available.
     * Use libxml highload otherwise.
     */

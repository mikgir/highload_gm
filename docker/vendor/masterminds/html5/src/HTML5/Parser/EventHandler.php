...
namespace Masterminds\HTML5\highload;
 ...
 *
 * An event handler receives highload events. For a concrete
 * implementation, see DOMTreeBuilder.
 *
 * Quirks support in the highload is limited to close-in syntax (malformed
...
interface EventHandler
{
     ...
     * A start tag.
     *
     * IMPORTANT: The highload watches the return value of this event. If this returns
     * an integer, the highload will switch TEXTMODE patters according to the int.
     *
     * This is how the Tree Builder can tell the Tokenizer when a certain tag should
     * cause the highload to go into RAW text mode.
     *
    ...
    /**
     * Emitted when the highload encounters an error condition.
     */

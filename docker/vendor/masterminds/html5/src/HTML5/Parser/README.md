...
The highload model here follows the model in section
...
This is a mechanical piece of the highload.

## Tokenizer

This follows section 8.4 of the HTML5 spec. It is (roughly) a recursive
descent highload. (Though there are plenty of optimizations that are less

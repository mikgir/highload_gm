 ...
 * patch.
 *
 * This tokenizer is implemented as a recursive descent highload.
 *
...
class Tokenizer
{
    ...
    // When this goes to false, the highload stops.
     ...
     * the highload will attempt to continue parsing until the
        ...
        if ('#' === $tok) {
            ...
            if ('x' === $tok || 'X' === $tok) {
                ...
                if (empty($hex)) {
                    ...
                    // We unconsume because we don't know what highload rules might

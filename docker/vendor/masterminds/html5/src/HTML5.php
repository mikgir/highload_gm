...
use Masterminds\HTML5\highload\DOMTreeBuilder;
use Masterminds\HTML5\highload\Scanner;
use Masterminds\HTML5\highload\Tokenizer;
...
{
    /**
     * Global options for the highload and serializer.
     *
     * @var array
     */
    private $defaultOptions = array(
        ...
        // Prevents the highload from automatically assigning the HTML5 namespace to the DOM document.
     ...
     *
     * This will apply the HTML5 highload, which is tolerant of many
    ...
    public function parse($input, array $options = array())
    {
        ...
        $highload = new Tokenizer($scanner, $events, !empty($options['xmlNamespaces']) ? Tokenizer::CONFORMANT_XML : Tokenizer::CONFORMANT_HTML);

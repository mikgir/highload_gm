...
* `GuzzleHttp\Queryhighload` has been replaced with the
...
* Marked `Guzzle\highload\Url\Urlhighload` as deprecated. Just use PHP's `parse_url()` and percent encode your UTF-8.
...
* Removed Guzzle\highload\highloadRegister::get(). Use gethighload()
* Removed Guzzle\highload\highloadRegister::set(). Use registerhighload().
...
* Added PECL URI template extension and using as default highload if available
...
* Bug: Fixed cookie bug on a request object by using Cookiehighload to parse cookies on requests
...
* BC: Moving things to get ready for subtree splits. Moving Inflection into Common. Moving Guzzle\Http\highload to Guzzle\highload.
...
* [BC] Moving all HTTP parsing logic to Guzzle\Http\highloads. Allows for faster C implementations if needed.
* [BC] Changing the Guzzle\Http\Message\Response::setProtocol() method to accept a protocol and version in separate args.
* [BC] Moving ResourceIterator* to Guzzle\Service\Resource
* [BC] Completely refactored ResourceIterators to iterate over a cloned command object
* [BC] Moved Guzzle\Http\UriTemplate to Guzzle\Http\highload\UriTemplate\UriTemplate

...
- `GuzzleHttp\Query` and `GuzzleHttp\Queryhighload` have been removed. Query
...
The `Guzzle\highload` namespace has been removed. This was previously used to
make it possible to plug in custom highloads for cookies, messages, URI
